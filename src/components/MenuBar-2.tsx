...
export const MenuBar_2 = () => {
    ...
    return (
        <div key={"menu-bar"} className="w-full bg-white relative z-50">
            <div className="w-full bg-white sticky top-0 z-50 px-4 md:px-6 lg:px-8">
                <Container>
                    <nav className="lg:px-8 relative flex flex-wrap items-center justify-between py-4">
                        ...
                        <button
                            ...
                            className="lg:hidden inline-flex items-center p-2 text-black hover:text-gray-300"
                        >
                                        ...
                                        {typeof item === 'string' ? (
                                            <Link 
                                                ...
                                                className={`
                                                    ...
                                                    font-bold text-[0.875rem] leading-[0.825rem] tracking-[0.081rem] text-black 
                                                ...
                                                <div className="relative">
                                                    <button
                                                        ...
                                                        className={`
                                                            ...
                                                            tracking-[0.081rem] text-black uppercase transition-colors rounded-md
                                                            ${activeItem === index ? 'bg-[#3288AE]' : 'hover:text-gray-300'}
                                                        `}
                                                    >
                                                        {item.name}
