...
const TechnologyCertification = () => {
  ...
  return (
    <section className="w-full px-4 md:px-6 lg:px-8 xl:px-[9.25rem] pb-16 pt-10 bg-white">
      <Container>
        <div className="container mx-auto px-4 lg:px-16">
          <h2 className="font-manrope font-semibold text-3xl md:text-4xl lg:text-5xl leading-tight text-center text-black mb-8 md:mb-12">
